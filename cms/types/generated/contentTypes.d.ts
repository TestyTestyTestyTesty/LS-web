...
export interface ApiHomepageHomepage extends Schema.SingleType {
	...
	attributes: {
		Hero: Attribute.Component<"modules.hero"> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		logos: Attribute.Component<"modules.logos"> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		infographic: Attribute.Component<"modules.infographic"> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		caseStudies: Attribute.Component<"modules.case-studies"> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
			}>
		cta: Attribute.Component<"modules.cta"> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
...
export interface ApiNavigationNavigation extends Schema.SingleType {
	...
	attributes: {
		menuLinks: Attribute.DynamicZone<["atom.link", "modules.mega-menu"]> &
			Attribute.SetPluginOptions<{
				i18n: {
					localized: true
				}
